...
Thermal state indicates the level of heat generated by logic components as they run apps. Optimize your app’s performance by monitoring the thermal state and reducing system usage as the thermal state increases. The following items will aspect the thermal problem:
...
### Are there any third party tools that provided for debuging the thermal problems
