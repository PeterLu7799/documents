...
2. AVCaptureSystemPressureState
	...
	* AVCaptureSystemPressureFactors - An enumerated string value characterizing the pressure level to which the system is currently elevated.
	...
	* AVCaptureSystemPressureLevel - A bitmask of values indicating the factors contributing to the current system pressure level.
